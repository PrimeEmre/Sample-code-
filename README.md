...
Welcome to the central repository for my coding experiments, AI-driven scripts, and web development projects. This repository hosts the official source code for the tutorials and projects featured on my professional platforms.

## 📖 Introduction
This repository is a versatile workspace documenting my journey as a frontend designer and developer. It contains a mix of production-ready code, learning exercises, and media assets used for image processing and animation experiments.
...
* 📖 **3D Maze Game Build** 🔗 [Blog Post](https://blog.emreguzel.ca/2025/08/21/program-a-game-in-unity/) | 📁 Key Files: [`BallController.cs`](./maze_game/BallController.cs) , [`tutorial 3.1.sln`](./maze_game/tutorial%203.1.sln)
* 📖 **Mini Projects & Installation** 🔗 [Blog Posts](https://blog.emreguzel.ca/2025/08/13/how-to-use-unity-with-right-installations/) | 📁 Folders: [`Assets`](./maze_game/Assets/) , [`Scenes`](./maze_game/Scenes/)
...
* **🌐 Main Portfolio**: [emreguzel.ca](https://emreguzel.ca/)
